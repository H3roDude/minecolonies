...
import com.minecolonies.coremod.entity.ai.citizen.crafter.EntityAICrafterCrafter;
...
/**
 * The job of the crafter.
 *
 * TODO this is a copy of the JobBuilder right now. Needs to be implemented
 */
public class JobCrafter extends AbstractJobStructure
{
    /**
     ...
     */
    public JobCrafter(final CitizenData entity)
    {
        super(entity);
    }
    ...
    @NotNull
    @Override
    public AbstractAISkeleton<JobCrafter> generateAI()
    {
        return new EntityAICrafterCrafter(this);
    }
