 ...
 */
public abstract class AbstractWindowCrafterBuilding<B extends AbstractBuildingWorker.View> extends AbstractWindowBuilding<B>
{
    /**
     ...
     */
    AbstractWindowCrafterBuilding(final B building, final String resource)
    {
