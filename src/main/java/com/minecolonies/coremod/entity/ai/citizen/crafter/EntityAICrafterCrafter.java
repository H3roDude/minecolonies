package com.minecolonies.coremod.entity.ai.citizen.crafter;
...
import com.minecolonies.coremod.colony.jobs.JobCrafter;
...
/**
 * AI class for the crafter.
 * Can craft advanced (3x3 grid) recipes.
 *
 * TODO this is a copy of the builder right now. Needs to be implemented
 */
public class EntityAICrafterCrafter extends AbstractEntityAIStructure<JobCrafter>
{
    /**
     ...
     */
    public EntityAICrafterCrafter(@NotNull final JobCrafter job)
    {
        super(job);
